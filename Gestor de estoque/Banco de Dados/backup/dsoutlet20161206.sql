...
CREATE TABLE `registro_entrada` (
  ...
  KEY `fk_registro_entrada_registro1_idx` (`registro_id`),
  ...
  CONSTRAINT `fk_registro_entrada_registro1` FOREIGN KEY (`registro_id`) REFERENCES `registro` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `registro_saida` (
  ...
  KEY `fk_registro_saida_registro1_idx` (`registro_id`),
  ...
  CONSTRAINT `fk_registro_saida_registro1` FOREIGN KEY (`registro_id`) REFERENCES `registro` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-12-06 23:08:55
